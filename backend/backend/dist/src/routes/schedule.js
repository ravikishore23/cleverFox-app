...
function parseDateRequired(input, label) {
...
function parseDateOptional(input) {
    if (input === undefined)
        return undefined;
    if (input === null)
        return undefined;
...
scheduleRouter.get("/schedule", asyncRoute(async (req, res) => {
    await connectMongo();
...
scheduleRouter.post("/schedule", asyncRoute(async (req, res) => {
    await connectMongo();
...
scheduleRouter.patch("/schedule/:id", asyncRoute(async (req, res) => {
    await connectMongo();
...
scheduleRouter.delete("/schedule/:id", asyncRoute(async (req, res) => {
    await connectMongo();
    const id = String(req.params.id);
